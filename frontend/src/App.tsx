        ...
        {view === "profile" ? (
          ...
          <div className="dashboard-content">
            <section className="match-overview-card">
              ...
              {selectedMatch ? <div className="match-scoreboard"><div className="team-circle team-ours" data-tooltip={`Fightclub IX · ${selectedMatch.ourScore} runs`} title={`Fightclub IX · ${selectedMatch.ourScore} runs`}><span>OUR TEAM</span><strong>Fightclub IX</strong><b>{selectedMatch.ourScore}</b></div><div className="match-result"><small>{selectedMatch.result}</small><span>VS</span><em>{selectedMatch.venue}</em></div><div className="team-circle team-opponent" data-tooltip={`${selectedMatch.opponent} · ${selectedMatch.opponentScore} runs`} title={`${selectedMatch.opponent} · ${selectedMatch.opponentScore} runs`}><span>OPPONENT</span><strong>{selectedMatch.opponent}</strong><b>{selectedMatch.opponentScore}</b></div></div> : <p className="loading-copy">Loading match history…</p>}
            </section>
