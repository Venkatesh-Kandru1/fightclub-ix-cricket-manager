      ...
      <main className="login-layout">
        <section className="login-visual" aria-label="Fightclub IX match-day preview">
          ...
          <div className="login-visual-content">
            <div className="team-lockup"><span className="team-emblem" aria-hidden="true"><span className="emblem-spark">✦</span><strong>IX</strong><small>FIGHT</small></span><span><strong>FIGHTCLUB</strong><small>IX · ESTD. 2023</small></span></div>
