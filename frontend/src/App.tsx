      ...
      <main className="login-layout">
        <section className="login-visual" aria-label="Fightclub IX match-day preview">
          ...
          <div className="login-visual-footer">
            <span><strong>14</strong> players</span><span><strong>1</strong> family</span>
          </div>
        </section>
  ...
  return (
    <main className={`app-shell ${darkMode ? "theme-dark" : ""}`}>
      <aside className={`sidebar ${sidebarCollapsed ? "is-collapsed" : ""}`}>
        ...
        <div className="team-health"><span><StatusDot /> ADMIN SESSION</span><strong>{players.length || 14} players</strong><small>Live squad performance</small></div>
