...
public sealed class RosterStore
{
    ...
    [
        ...
        new(2, "Rohan Patel", "RP", "Batsman", "rohan@fightclubix.local", "+1 416 555 0102", 366, 0, 12, "Available", "2024-03-12"),
        ...
        new(15, "Aarav Nair", "AN", "Wicket-keeper", "aarav@fightclubix.local", "+1 416 555 0115", 92, 0, 17, "Available", "2024-06-15"),
